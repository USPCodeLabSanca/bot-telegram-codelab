...
* [Legenda: Atributos](#legenda-atributos)
* [Princípios Gerais de um Handler](#princípios-gerais-de-um-handler)
* [Módulo: codelab.py](#módulo-codelabpy-)
    * [CodelabHandler](#codelabhandler)
* [Módulo: feedbacks.py](#módulo-feedbackspy-️)
    * [FeedbackMain](#feedbackmain)
    * [FeedbackAdd](#feedbackadd)
    * [FeedbackHelper](#feedbackhelper)
* [Módulo: fronts.py](#módulo-frontspy-)
    * [ShowFronts](#showfronts)
* [Módulo: git_invite.py](#módulo-git_invitepy-)
    * [GitInvite](#gitinvite)
