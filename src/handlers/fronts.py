...
class ShowFronts(msg_handler):
    ...
    def __call__(self, msg: telebot.types.Message):
        ...
        self.BOT.send_message(msg.chat.id, fronts, reply_markup=markup, message_thread_id=msg.message_thread_id)
